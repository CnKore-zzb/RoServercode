...
namespace RO\Cmd {
  ...
  class PetInfoUpdatePetCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_PET_PROTOCMD;
    
    /**  @var int - \RO\Cmd\PetParam */
    public $param = \RO\Cmd\PetParam::PETPARAM_PETINFO_UPDATE;
    
    /**  @var int */
    public $petid = null;
    
    /**  @var \RO\Cmd\PetMemberData[]  */
    public $datas = array();
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.PetInfoUpdatePetCmd');
      ...
      $f->default   = \RO\Cmd\PetParam::PETPARAM_PETINFO_UPDATE;
      $descriptor->addField($f);
      ...
      $f->reference = '\RO\Cmd\PetMemberData';
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\PetInfoUpdatePetCmd
     */
     ...
     * Set <datas> value
     *
     * @param \RO\Cmd\PetMemberData $value
     * @return \RO\Cmd\PetInfoUpdatePetCmd
     */
    public function setDatas(\RO\Cmd\PetMemberData $value, $idx = NULL){
     ...
     * @return \RO\Cmd\PetInfoUpdatePetCmd
     */
    public function addDatas(\RO\Cmd\PetMemberData $value){
