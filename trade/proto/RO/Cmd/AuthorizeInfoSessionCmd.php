...
namespace RO\Cmd {
  ...
  class AuthorizeInfoSessionCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SESSION_PROTOCMD;
    
    /**  @var int - \RO\Cmd\SessionParam */
    public $param = \RO\Cmd\SessionParam::SESSIONPARAM_SYNC_AUTHORIZE;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.AuthorizeInfoSessionCmd');
      ...
      $f->default   = \RO\Cmd\SessionParam::SESSIONPARAM_SYNC_AUTHORIZE;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\AuthorizeInfoSessionCmd
     */
