...
namespace RO\Cmd {
  ...
  class CheckSeatUserCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER2_PROTOCMD;
    
    /**  @var int - \RO\Cmd\User2Param */
    public $param = \RO\Cmd\User2Param::USER2PARAM_CHECK_SEAT;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.CheckSeatUserCmd');
      ...
      $f->default   = \RO\Cmd\User2Param::USER2PARAM_CHECK_SEAT;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\CheckSeatUserCmd
     */
