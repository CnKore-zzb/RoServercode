...
namespace RO\Cmd {
  ...
  class QueryTreasureResultGuildCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SESSION_USER_GUILD_PROTOCMD;
    
    /**  @var int - \RO\Cmd\GuildParam */
    public $param = \RO\Cmd\GuildParam::GUILDPARAM_TREASURE_QUERYRESULT;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.QueryTreasureResultGuildCmd');
      ...
      $f->default   = \RO\Cmd\GuildParam::GUILDPARAM_TREASURE_QUERYRESULT;
      $descriptor->addField($f);

      // OPTIONAL UINT32 eventguid = 3
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 3;
      $f->name      = "eventguid";
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\QueryTreasureResultGuildCmd
     */
