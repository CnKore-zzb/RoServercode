...
namespace RO\Cmd {
  ...
  class GetRewardStageUserCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::FUBEN_PROTOCMD;
    
    /**  @var int - \RO\Cmd\FuBenParam */
    public $param = \RO\Cmd\FuBenParam::GET_REWARD_STAGE_USER_CMD;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.GetRewardStageUserCmd');
      ...
      $f->default   = \RO\Cmd\FuBenParam::GET_REWARD_STAGE_USER_CMD;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\GetRewardStageUserCmd
     */
