...
namespace RO\Cmd {
  ...
  class WantedInfoSyncSessionCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SESSION_PROTOCMD;
    
    /**  @var int - \RO\Cmd\SessionParam */
    public $param = \RO\Cmd\SessionParam::SESSIONPARAM_WANTED_INFO_SYNC;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.WantedInfoSyncSessionCmd');
      ...
      $f->default   = \RO\Cmd\SessionParam::SESSIONPARAM_WANTED_INFO_SYNC;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\WantedInfoSyncSessionCmd
     */
