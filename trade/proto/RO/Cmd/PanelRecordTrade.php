...
namespace RO\Cmd {
  ...
  class PanelRecordTrade extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::RECORD_USER_TRADE_PROTOCMD;
    
    /**  @var int - \RO\Cmd\RecordUserTradeParam */
    public $param = \RO\Cmd\RecordUserTradeParam::PANEL_RECORDTRADE;
    
    /**  @var int */
    public $charid = null;
    
    /**  @var int - \RO\Cmd\EPanelOperType */
    public $oper = null;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.PanelRecordTrade');
      ...
      $f->default   = \RO\Cmd\RecordUserTradeParam::PANEL_RECORDTRADE;
      $descriptor->addField($f);
      ...
      $f->type      = \DrSlump\Protobuf::TYPE_ENUM;
      $f->rule      = \DrSlump\Protobuf::RULE_OPTIONAL;
      $f->reference = '\RO\Cmd\EPanelOperType';
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\PanelRecordTrade
     */
     ...
     * Get <oper> value
     *
     * @return int - \RO\Cmd\EPanelOperType
     */
     ...
     * Set <oper> value
     *
     * @param int - \RO\Cmd\EPanelOperType $value
     * @return \RO\Cmd\PanelRecordTrade
     */
