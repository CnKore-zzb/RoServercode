...
namespace RO\Cmd {
  ...
  class AcceptTradeCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::RECORD_USER_TRADE_PROTOCMD;
    
    /**  @var int - \RO\Cmd\RecordUserTradeParam */
    public $param = \RO\Cmd\RecordUserTradeParam::ACCEPT_TRADE_PARAM;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.AcceptTradeCmd');
      ...
      $f->default   = \RO\Cmd\RecordUserTradeParam::ACCEPT_TRADE_PARAM;
      $descriptor->addField($f);
