...
namespace RO\Cmd {
  ...
  class SocailLogCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::LOG_PROTOCMD;
    
    /**  @var int - \RO\Cmd\LogParam */
    public $param = \RO\Cmd\LogParam::SOCIAL_LOG_CMD;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.SocailLogCmd');
      ...
      $f->default   = \RO\Cmd\LogParam::SOCIAL_LOG_CMD;
      $descriptor->addField($f);
    ...
    /**
     * Check if <inid> has a value
     *
     * @return boolean
     */
    public function hasInid(){
      return $this->_has(13);
    }
