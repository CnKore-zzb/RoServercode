...
namespace RO\Cmd {
  ...
  class BeingInfoUpdate extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_BEING_PROTOCMD;
    
    /**  @var int - \RO\Cmd\BeingParam */
    public $param = \RO\Cmd\BeingParam::BEINGPARAM_BEING_INFO_UPDATE;
    
    /**  @var int */
    public $beingid = null;
    
    /**  @var \RO\Cmd\BeingMemberData[]  */
    public $datas = array();
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.BeingInfoUpdate');
      ...
      $f->default   = \RO\Cmd\BeingParam::BEINGPARAM_BEING_INFO_UPDATE;
      $descriptor->addField($f);
      ...
      $f->reference = '\RO\Cmd\BeingMemberData';
      $descriptor->addField($f);
     ...
     * Set <datas> value
     *
     * @param \RO\Cmd\BeingMemberData $value
     * @return \RO\Cmd\BeingInfoUpdate
     */
    public function setDatas(\RO\Cmd\BeingMemberData $value, $idx = NULL){
     ...
     * @return \RO\Cmd\BeingInfoUpdate
     */
    public function addDatas(\RO\Cmd\BeingMemberData $value){
