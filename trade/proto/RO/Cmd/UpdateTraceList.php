...
namespace RO\Cmd {
  ...
  class UpdateTraceList extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER2_PROTOCMD;
    
    /**  @var int - \RO\Cmd\User2Param */
    public $param = \RO\Cmd\User2Param::USER2PARAM_UPDATE_TRACE_LIST;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.UpdateTraceList');
      ...
      $f->default   = \RO\Cmd\User2Param::USER2PARAM_UPDATE_TRACE_LIST;
      $descriptor->addField($f);
     ...
     * @return \RO\Cmd\UpdateTraceList
     */
    public function setUpdates(\RO\Cmd\TraceItem $value, $idx = NULL){
     ...
     * @return \RO\Cmd\UpdateTraceList
     */
    public function addUpdates(\RO\Cmd\TraceItem $value){
