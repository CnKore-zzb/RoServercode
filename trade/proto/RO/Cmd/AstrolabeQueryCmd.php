...
namespace RO\Cmd {
  ...
  class AstrolabeQueryCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_ASTROLABE_PROTOCMD;
    
    /**  @var int - \RO\Cmd\AstrolabeParam */
    public $param = \RO\Cmd\AstrolabeParam::ASTROLABEPARAM_QUERY;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.AstrolabeQueryCmd');
      ...
      $f->default   = \RO\Cmd\AstrolabeParam::ASTROLABEPARAM_QUERY;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\AstrolabeQueryCmd
     */
