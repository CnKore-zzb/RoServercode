...
namespace RO\Cmd {
  ...
  class MailUpdate extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SESSION_USER_MAIL_PROTOCMD;
    
    /**  @var int - \RO\Cmd\MailParam */
    public $param = \RO\Cmd\MailParam::MAILPARAM_UPDATE;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.MailUpdate');
      ...
      $f->default   = \RO\Cmd\MailParam::MAILPARAM_UPDATE;
      $descriptor->addField($f);
     ...
     * @return \RO\Cmd\MailUpdate
     */
    public function setUpdates(\RO\Cmd\MailData $value, $idx = NULL){
     ...
     * @return \RO\Cmd\MailUpdate
     */
    public function addUpdates(\RO\Cmd\MailData $value){
