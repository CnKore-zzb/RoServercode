...
namespace RO\Cmd {
  ...
  class UpdateDonateItemGuildCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SESSION_USER_GUILD_PROTOCMD;
    
    /**  @var int - \RO\Cmd\GuildParam */
    public $param = \RO\Cmd\GuildParam::GUILDPARAM_UPDATEDONATEITEM;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.UpdateDonateItemGuildCmd');
      ...
      $f->default   = \RO\Cmd\GuildParam::GUILDPARAM_UPDATEDONATEITEM;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\UpdateDonateItemGuildCmd
     */
     ...
     * @return \RO\Cmd\UpdateDonateItemGuildCmd
     */
    public function setDel(\RO\Cmd\DonateItem $value){
