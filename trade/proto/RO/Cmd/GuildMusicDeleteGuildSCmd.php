...
namespace RO\Cmd {
  ...
  class GuildMusicDeleteGuildSCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::GUILD_PROTOCMD;
    
    /**  @var int - \RO\Cmd\GuildSParam */
    public $param = \RO\Cmd\GuildSParam::GUILDSPARAM_GUILD_MUSIC_DELETE;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.GuildMusicDeleteGuildSCmd');
      ...
      $f->default   = \RO\Cmd\GuildSParam::GUILDSPARAM_GUILD_MUSIC_DELETE;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\GuildMusicDeleteGuildSCmd
     */
