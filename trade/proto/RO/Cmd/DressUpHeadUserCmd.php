...
namespace RO\Cmd {
  ...
  class DressUpHeadUserCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER2_PROTOCMD;
    
    /**  @var int - \RO\Cmd\User2Param */
    public $param = \RO\Cmd\User2Param::USER2PARAM_DRESSUP_HEAD;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.DressUpHeadUserCmd');
      ...
      $f->default   = \RO\Cmd\User2Param::USER2PARAM_DRESSUP_HEAD;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\DressUpHeadUserCmd
     */
    ...
    /**
     * Check if <puton> has a value
     *
     * @return boolean
     */
    public function hasPuton(){
      return $this->_has(5);
    }
     ...
     * @return \RO\Cmd\DressUpHeadUserCmd
     */
    public function setPuton( $value){
