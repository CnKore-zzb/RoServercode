...
namespace RO\Cmd {
  ...
  class NewFoodDataNtf extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_FOOD_PROTOCMD;
    
    /**  @var int - \RO\Cmd\FoodParam */
    public $param = \RO\Cmd\FoodParam::FOODPARAM_NEW_FOOD_DATA_NTF;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.NewFoodDataNtf');
      ...
      $f->default   = \RO\Cmd\FoodParam::FOODPARAM_NEW_FOOD_DATA_NTF;
      $descriptor->addField($f);
