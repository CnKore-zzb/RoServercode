...
namespace RO\Cmd {
  ...
  class BeginSeal extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_SEAL_PROTOCMD;
    
    /**  @var int - \RO\Cmd\SealParam */
    public $param = \RO\Cmd\SealParam::SEALPARAM_BEGINSEAL;
    
    /**  @var int */
    public $sealid = 0;
    
    /**  @var int - \RO\Cmd\EFinishType */
    public $etype = \RO\Cmd\EFinishType::EFINISHTYPE_NORMAL;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.BeginSeal');
      ...
      $f->default   = \RO\Cmd\SealParam::SEALPARAM_BEGINSEAL;
      $descriptor->addField($f);

      // OPTIONAL UINT64 sealid = 3
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 3;
      $f->name      = "sealid";
      ...
      $f->type      = \DrSlump\Protobuf::TYPE_ENUM;
      $f->rule      = \DrSlump\Protobuf::RULE_OPTIONAL;
      $f->reference = '\RO\Cmd\EFinishType';
      $f->default   = \RO\Cmd\EFinishType::EFINISHTYPE_NORMAL;
      $descriptor->addField($f);
     ...
     * Set <etype> value
     *
     * @param int - \RO\Cmd\EFinishType $value
     * @return \RO\Cmd\BeginSeal
     */
