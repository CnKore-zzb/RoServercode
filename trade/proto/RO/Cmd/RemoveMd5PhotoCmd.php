...
namespace RO\Cmd {
  ...
  class RemoveMd5PhotoCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_PHOTO_PROTOCMD;
    
    /**  @var int - \RO\Cmd\PhotoParam */
    public $param = \RO\Cmd\PhotoParam::PHOTOPARAM_REMOVE_MD5;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.RemoveMd5PhotoCmd');
      ...
      $f->default   = \RO\Cmd\PhotoParam::PHOTOPARAM_REMOVE_MD5;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\RemoveMd5PhotoCmd
     */
