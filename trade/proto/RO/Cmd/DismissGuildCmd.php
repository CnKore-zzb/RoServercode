...
namespace RO\Cmd {
  ...
  class DismissGuildCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SESSION_USER_GUILD_PROTOCMD;
    
    /**  @var int - \RO\Cmd\GuildParam */
    public $param = \RO\Cmd\GuildParam::GUILDPARAM_DISMISSGUILD;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.DismissGuildCmd');
      ...
      $f->default   = \RO\Cmd\GuildParam::GUILDPARAM_DISMISSGUILD;
      $descriptor->addField($f);
