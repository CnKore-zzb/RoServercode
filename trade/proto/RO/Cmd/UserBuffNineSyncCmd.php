...
namespace RO\Cmd {
  ...
  class UserBuffNineSyncCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER2_PROTOCMD;
    
    /**  @var int - \RO\Cmd\User2Param */
    public $param = \RO\Cmd\User2Param::USER2PARAM_BUFFERSYNC;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.UserBuffNineSyncCmd');
      ...
      $f->default   = \RO\Cmd\User2Param::USER2PARAM_BUFFERSYNC;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\UserBuffNineSyncCmd
     */
     ...
     * @return \RO\Cmd\UserBuffNineSyncCmd
     */
    public function setUpdates(\RO\Cmd\BufferData $value, $idx = NULL){
     ...
     * @return \RO\Cmd\UserBuffNineSyncCmd
     */
    public function addUpdates(\RO\Cmd\BufferData $value){
