...
namespace RO\Cmd {
  ...
  class LotteryRateQueryCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_ITEM_PROTOCMD;
    
    /**  @var int - \RO\Cmd\ItemParam */
    public $param = \RO\Cmd\ItemParam::ITEMPARAM_LOTTERY_RATE_QUERY;
    
    /**  @var int - \RO\Cmd\ELotteryType */
    public $type = null;
    
    /**  @var \RO\Cmd\LotteryRateInfo[]  */
    public $infos = array();
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.LotteryRateQueryCmd');
      ...
      $f->default   = \RO\Cmd\ItemParam::ITEMPARAM_LOTTERY_RATE_QUERY;
      $descriptor->addField($f);
      ...
      $f->reference = '\RO\Cmd\LotteryRateInfo';
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\LotteryRateQueryCmd
     */
     ...
     * Set <infos> value
     *
     * @param \RO\Cmd\LotteryRateInfo $value
     * @return \RO\Cmd\LotteryRateQueryCmd
     */
    public function setInfos(\RO\Cmd\LotteryRateInfo $value, $idx = NULL){
     ...
     * @return \RO\Cmd\LotteryRateQueryCmd
     */
    public function addInfos(\RO\Cmd\LotteryRateInfo $value){
