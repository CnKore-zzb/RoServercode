...
namespace RO\Cmd {
  ...
  class CreditLogCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::LOG_PROTOCMD;
    
    /**  @var int - \RO\Cmd\LogParam */
    public $param = \RO\Cmd\LogParam::CREDIT_LOG_CMD;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.CreditLogCmd');
      ...
      $f->default   = \RO\Cmd\LogParam::CREDIT_LOG_CMD;
      $descriptor->addField($f);
      ...
      $f->type      = \DrSlump\Protobuf::TYPE_ENUM;
      $f->rule      = \DrSlump\Protobuf::RULE_OPTIONAL;
      $f->reference = '\RO\Cmd\ECreditType';
      $descriptor->addField($f);
     ...
     * Set <type> value
     *
     * @param int - \RO\Cmd\ECreditType $value
     * @return \RO\Cmd\CreditLogCmd
     */
