...
namespace RO\Cmd {
  ...
  class QueryBuildingRankGuildCmd extends \DrSlump\Protobuf\Message {
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.QueryBuildingRankGuildCmd');
      ...
      $f->default   = \RO\Cmd\GuildParam::GUILDPARAM_QUERY_BUILDING_RANK;
      $descriptor->addField($f);
      ...
      $f->reference = '\RO\Cmd\BuildingSubmitRankItem';
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\QueryBuildingRankGuildCmd
     */
     ...
     * Set <items> value
     *
     * @param \RO\Cmd\BuildingSubmitRankItem $value
     * @return \RO\Cmd\QueryBuildingRankGuildCmd
     */
    public function setItems(\RO\Cmd\BuildingSubmitRankItem $value, $idx = NULL){
     ...
     * @return \RO\Cmd\QueryBuildingRankGuildCmd
     */
    public function addItems(\RO\Cmd\BuildingSubmitRankItem $value){
