...
namespace RO\Cmd {
  ...
  class SendMailGuildSCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::GUILD_PROTOCMD;
    
    /**  @var int - \RO\Cmd\GuildSParam */
    public $param = \RO\Cmd\GuildSParam::GUILDSPARAM_SEND_MAIL;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.SendMailGuildSCmd');
      ...
      $f->default   = \RO\Cmd\GuildSParam::GUILDSPARAM_SEND_MAIL;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\SendMailGuildSCmd
     */
