...
namespace RO\Cmd {
  ...
  class ReconnectionPosUserCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_PROTOCMD;
    
    /**  @var int - \RO\Cmd\CmdParam */
    public $param = \RO\Cmd\CmdParam::RECONNECTION_POS_USER_CMD;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.ReconnectionPosUserCmd');
      ...
      $f->default   = \RO\Cmd\CmdParam::RECONNECTION_POS_USER_CMD;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\ReconnectionPosUserCmd
     */
