...
namespace RO\Cmd {
  ...
  class GoToRandomPosUserCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_PROTOCMD;
    
    /**  @var int - \RO\Cmd\CmdParam */
    public $param = \RO\Cmd\CmdParam::GOTO_RANDOM_POS_USER_CMD;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.GoToRandomPosUserCmd');
      ...
      $f->default   = \RO\Cmd\CmdParam::GOTO_RANDOM_POS_USER_CMD;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\GoToRandomPosUserCmd
     */
