...
namespace RO\Cmd {
  ...
  class DeleteRecordUserCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER2_PROTOCMD;
    
    /**  @var int - \RO\Cmd\User2Param */
    public $param = \RO\Cmd\User2Param::USER2PARAM_DELETE_RECORD;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.DeleteRecordUserCmd');
      ...
      $f->default   = \RO\Cmd\User2Param::USER2PARAM_DELETE_RECORD;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\DeleteRecordUserCmd
     */
