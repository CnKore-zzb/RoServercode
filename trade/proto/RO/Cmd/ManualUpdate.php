...
namespace RO\Cmd {
  ...
  class ManualUpdate extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_MANUAL_PROTOCMD;
    
    /**  @var int - \RO\Cmd\ManualParam */
    public $param = \RO\Cmd\ManualParam::MANUALPARAM_UPDATE;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.ManualUpdate');
      ...
      $f->default   = \RO\Cmd\ManualParam::MANUALPARAM_UPDATE;
      $descriptor->addField($f);
     ...
     * @return \RO\Cmd\ManualUpdate
     */
    public function setUpdate(\RO\Cmd\ManualItem $value){
