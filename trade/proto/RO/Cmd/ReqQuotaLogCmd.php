...
namespace RO\Cmd {
  ...
  class ReqQuotaLogCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_ITEM_PROTOCMD;
    
    /**  @var int - \RO\Cmd\ItemParam */
    public $param = \RO\Cmd\ItemParam::ITEMPARAM_REQ_QUOTA_LOG;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.ReqQuotaLogCmd');
      ...
      $f->default   = \RO\Cmd\ItemParam::ITEMPARAM_REQ_QUOTA_LOG;
      $descriptor->addField($f);
     ...
     * @return \RO\Cmd\ReqQuotaLogCmd
     */
    public function setLog(\RO\Cmd\QuotaLog $value, $idx = NULL){
     ...
     * @return \RO\Cmd\ReqQuotaLogCmd
     */
    public function addLog(\RO\Cmd\QuotaLog $value){
