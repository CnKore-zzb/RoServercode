...
namespace RO\Cmd {
  ...
  class WelfareNtfGuildCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SESSION_USER_GUILD_PROTOCMD;
    
    /**  @var int - \RO\Cmd\GuildParam */
    public $param = \RO\Cmd\GuildParam::GUILDPARAM_WELFARE_NTF;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.WelfareNtfGuildCmd');
      ...
      $f->default   = \RO\Cmd\GuildParam::GUILDPARAM_WELFARE_NTF;
      $descriptor->addField($f);

      // OPTIONAL BOOL welfare = 3
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 3;
      $f->name      = "welfare";
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\WelfareNtfGuildCmd
     */
     ...
     * @return \RO\Cmd\WelfareNtfGuildCmd
     */
    public function setWelfare( $value){
