...
namespace RO\Cmd {
  ...
  class ExitChatRoom extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_CHATROOM_PROTOCMD;
    
    /**  @var int - \RO\Cmd\EChatRoomParam */
    public $param = \RO\Cmd\EChatRoomParam::ECHATROOMPARAM_EXIT;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.ExitChatRoom');
      ...
      $f->default   = \RO\Cmd\EChatRoomParam::ECHATROOMPARAM_EXIT;
      $descriptor->addField($f);
