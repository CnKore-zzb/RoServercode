...
namespace RO\Cmd {
  ...
  class QueryGuildCityInfoGuildCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SESSION_USER_GUILD_PROTOCMD;
    
    /**  @var int - \RO\Cmd\GuildParam */
    public $param = \RO\Cmd\GuildParam::GUILDPARAM_QUERY_CITYINFO;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.QueryGuildCityInfoGuildCmd');
      ...
      $f->default   = \RO\Cmd\GuildParam::GUILDPARAM_QUERY_CITYINFO;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\QueryGuildCityInfoGuildCmd
     */
