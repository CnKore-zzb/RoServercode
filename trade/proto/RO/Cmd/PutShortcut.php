...
namespace RO\Cmd {
  ...
  class PutShortcut extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER2_PROTOCMD;
    
    /**  @var int - \RO\Cmd\User2Param */
    public $param = \RO\Cmd\User2Param::USER2PARAM_PUTSHORTCUT;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.PutShortcut');
      ...
      $f->default   = \RO\Cmd\User2Param::USER2PARAM_PUTSHORTCUT;
      $descriptor->addField($f);
     ...
     * @return \RO\Cmd\PutShortcut
     */
    public function setItem(\RO\Cmd\ShortcutItem $value){
