...
namespace RO\Cmd {
  ...
  class EnterGuildTerritorySessionCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SESSION_PROTOCMD;
    
    /**  @var int - \RO\Cmd\SessionParam */
    public $param = \RO\Cmd\SessionParam::SESSIONPARAM_ENTERGUILD;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.EnterGuildTerritorySessionCmd');
      ...
      $f->default   = \RO\Cmd\SessionParam::SESSIONPARAM_ENTERGUILD;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\EnterGuildTerritorySessionCmd
     */
