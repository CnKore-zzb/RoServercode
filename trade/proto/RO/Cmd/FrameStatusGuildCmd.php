...
namespace RO\Cmd {
  ...
  class FrameStatusGuildCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SESSION_USER_GUILD_PROTOCMD;
    
    /**  @var int - \RO\Cmd\GuildParam */
    public $param = \RO\Cmd\GuildParam::GUILDPARAM_FRAME_STATUS;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.FrameStatusGuildCmd');
      ...
      $f->default   = \RO\Cmd\GuildParam::GUILDPARAM_FRAME_STATUS;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\FrameStatusGuildCmd
     */
