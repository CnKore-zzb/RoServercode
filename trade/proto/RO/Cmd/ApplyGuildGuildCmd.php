...
namespace RO\Cmd {
  ...
  class ApplyGuildGuildCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SESSION_USER_GUILD_PROTOCMD;
    
    /**  @var int - \RO\Cmd\GuildParam */
    public $param = \RO\Cmd\GuildParam::GUILDPARAM_APPLYGUILD;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.ApplyGuildGuildCmd');
      ...
      $f->default   = \RO\Cmd\GuildParam::GUILDPARAM_APPLYGUILD;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\ApplyGuildGuildCmd
     */
