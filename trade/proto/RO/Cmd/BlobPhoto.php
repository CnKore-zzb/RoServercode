...
namespace RO\Cmd {
  ...
  class BlobPhoto extends \DrSlump\Protobuf\Message {
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.BlobPhoto');
     ...
     * @return \RO\Cmd\BlobPhoto
     */
    public function setItems(\RO\Cmd\PhotoItem $value, $idx = NULL){
     ...
     * @return \RO\Cmd\BlobPhoto
     */
    public function addItems(\RO\Cmd\PhotoItem $value){
