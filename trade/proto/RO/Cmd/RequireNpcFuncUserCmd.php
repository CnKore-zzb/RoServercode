...
namespace RO\Cmd {
  ...
  class RequireNpcFuncUserCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER2_PROTOCMD;
    
    /**  @var int - \RO\Cmd\User2Param */
    public $param = \RO\Cmd\User2Param::USER2PARAM_REQUIRENPCFUNC;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.RequireNpcFuncUserCmd');
      ...
      $f->default   = \RO\Cmd\User2Param::USER2PARAM_REQUIRENPCFUNC;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\RequireNpcFuncUserCmd
     */
     ...
     * @return string
     */
    public function getFunctions($idx = NULL){
     ...
     * @return \RO\Cmd\RequireNpcFuncUserCmd
     */
    public function setFunctions( $value, $idx = NULL){
      return $this->_set(4, $value, $idx);
    }
    
    /**
     * Get all elements of <functions>
     *
     * @return string[]
     */
     ...
     * @return \RO\Cmd\RequireNpcFuncUserCmd
     */
    public function addFunctions( $value){
