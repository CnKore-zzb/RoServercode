...
namespace RO\Cmd {
  ...
  class BuildingSubmitCountGuildCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SESSION_USER_GUILD_PROTOCMD;
    
    /**  @var int - \RO\Cmd\GuildParam */
    public $param = \RO\Cmd\GuildParam::GUILDPARAM_BUILDING_SUBMIT_COUNT;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.BuildingSubmitCountGuildCmd');
      ...
      $f->default   = \RO\Cmd\GuildParam::GUILDPARAM_BUILDING_SUBMIT_COUNT;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\BuildingSubmitCountGuildCmd
     */
