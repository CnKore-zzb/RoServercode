...
namespace RO\Cmd {
  ...
  class NpcSearchRangeCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_MAP_PROTOCMD;
    
    /**  @var int - \RO\Cmd\MapParam */
    public $param = \RO\Cmd\MapParam::MAPPARAM_NPC_SEARCH_RANGE;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.NpcSearchRangeCmd');
      ...
      $f->default   = \RO\Cmd\MapParam::MAPPARAM_NPC_SEARCH_RANGE;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\NpcSearchRangeCmd
     */
