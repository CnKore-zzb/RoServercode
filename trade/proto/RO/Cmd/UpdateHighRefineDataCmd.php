...
namespace RO\Cmd {
  ...
  class UpdateHighRefineDataCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_ITEM_PROTOCMD;
    
    /**  @var int - \RO\Cmd\ItemParam */
    public $param = \RO\Cmd\ItemParam::ITEMPARAM_UPDATE_HIGHTREFINE_DATA;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.UpdateHighRefineDataCmd');
      ...
      $f->default   = \RO\Cmd\ItemParam::ITEMPARAM_UPDATE_HIGHTREFINE_DATA;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\UpdateHighRefineDataCmd
     */
     ...
     * @return \RO\Cmd\UpdateHighRefineDataCmd
     */
    public function setData(\RO\Cmd\HighRefineData $value){
