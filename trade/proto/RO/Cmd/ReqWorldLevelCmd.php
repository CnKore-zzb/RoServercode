...
namespace RO\Cmd {
  ...
  class ReqWorldLevelCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::STAT_PROTOCMD;
    
    /**  @var int - \RO\Cmd\StatParam */
    public $param = \RO\Cmd\StatParam::REQ_WORLD_LEVEL;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.ReqWorldLevelCmd');
      ...
      $f->default   = \RO\Cmd\StatParam::REQ_WORLD_LEVEL;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\ReqWorldLevelCmd
     */
