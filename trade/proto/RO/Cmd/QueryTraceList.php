...
namespace RO\Cmd {
  ...
  class QueryTraceList extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER2_PROTOCMD;
    
    /**  @var int - \RO\Cmd\User2Param */
    public $param = \RO\Cmd\User2Param::USER2PARAM_QUERY_TRACE_LIST;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.QueryTraceList');
      ...
      $f->default   = \RO\Cmd\User2Param::USER2PARAM_QUERY_TRACE_LIST;
      $descriptor->addField($f);
