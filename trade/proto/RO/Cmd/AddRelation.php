...
namespace RO\Cmd {
  ...
  class AddRelation extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SESSION_USER_SOCIALITY_PROTOCMD;
    
    /**  @var int - \RO\Cmd\SocialityParam */
    public $param = \RO\Cmd\SocialityParam::SOCIALITYPARAM_ADDRELATION;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.AddRelation');
      ...
      $f->default   = \RO\Cmd\SocialityParam::SOCIALITYPARAM_ADDRELATION;
      $descriptor->addField($f);
