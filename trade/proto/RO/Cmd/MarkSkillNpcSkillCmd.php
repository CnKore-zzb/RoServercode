...
namespace RO\Cmd {
  ...
  class MarkSkillNpcSkillCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_SKILL_PROTOCMD;
    
    /**  @var int - \RO\Cmd\SkillParam */
    public $param = \RO\Cmd\SkillParam::SKILLPARAM_MARK_SKILLNPC;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.MarkSkillNpcSkillCmd');
      ...
      $f->default   = \RO\Cmd\SkillParam::SKILLPARAM_MARK_SKILLNPC;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\MarkSkillNpcSkillCmd
     */
