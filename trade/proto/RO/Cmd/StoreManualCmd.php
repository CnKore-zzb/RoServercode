...
namespace RO\Cmd {
  ...
  class StoreManualCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_MANUAL_PROTOCMD;
    
    /**  @var int - \RO\Cmd\ManualParam */
    public $param = \RO\Cmd\ManualParam::MANUALPARAM_STOREITEM;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.StoreManualCmd');
      ...
      $f->default   = \RO\Cmd\ManualParam::MANUALPARAM_STOREITEM;
      $descriptor->addField($f);
