...
namespace RO\Cmd {
  ...
  class ConsumeLogCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::LOG_PROTOCMD;
    
    /**  @var int - \RO\Cmd\LogParam */
    public $param = \RO\Cmd\LogParam::CONSUME_LOG_CMD;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.ConsumeLogCmd');
      ...
      $f->default   = \RO\Cmd\LogParam::CONSUME_LOG_CMD;
      $descriptor->addField($f);
    ...
    /**
     * Check if <microtime> has a value
     *
     * @return boolean
     */
     ...
     * @return \RO\Cmd\ConsumeLogCmd
     */
    public function setMicrotime( $value){
    ...
    /**
     * Check if <coin_type> has a value
     *
     * @return boolean
     */
    ...
    /**
     * Check if <chargecount> has a value
     *
     * @return boolean
     */
    public function hasChargecount(){
      return $this->_has(21);
    }
    
    /**
     * Clear <chargecount> value
     *
     * @return \RO\Cmd\ConsumeLogCmd
     */
    public function clearChargecount(){
      return $this->_clear(21);
    }
    
    /**
     * Get <chargecount> value
     *
     * @return int
     */
    ...
    /**
     * Check if <remaincharge> has a value
     *
     * @return boolean
     */
    public function hasRemaincharge(){
      return $this->_has(22);
    }
    
    /**
     * Clear <remaincharge> value
     *
     * @return \RO\Cmd\ConsumeLogCmd
     */
    public function clearRemaincharge(){
      return $this->_clear(22);
    }
    
    /**
     * Get <remaincharge> value
     *
     * @return int
     */
    ...
    /**
     * Set <remaincharge> value
     *
     * @param int $value
     * @return \RO\Cmd\ConsumeLogCmd
     */
    public function setRemaincharge( $value){
