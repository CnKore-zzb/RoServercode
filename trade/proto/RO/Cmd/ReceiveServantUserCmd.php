...
namespace RO\Cmd {
  ...
  class ReceiveServantUserCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER2_PROTOCMD;
    
    /**  @var int - \RO\Cmd\User2Param */
    public $param = \RO\Cmd\User2Param::USER2PARAM_SERVANT_RECEIVE;
    
    /**  @var boolean */
    public $favorability = false;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.ReceiveServantUserCmd');
      ...
      $f->default   = \RO\Cmd\User2Param::USER2PARAM_SERVANT_RECEIVE;
      $descriptor->addField($f);

      // OPTIONAL BOOL favorability = 3
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 3;
      $f->name      = "favorability";
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\ReceiveServantUserCmd
     */
