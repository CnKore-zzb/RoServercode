...
namespace RO\Cmd {
  ...
  class SummonBossSessionCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SESSION_PROTOCMD;
    
    /**  @var int - \RO\Cmd\SessionParam */
    public $param = \RO\Cmd\SessionParam::SUMMON_BOSS_SESSIONCMD;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.SummonBossSessionCmd');
      ...
      $f->default   = \RO\Cmd\SessionParam::SUMMON_BOSS_SESSIONCMD;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\SummonBossSessionCmd
     */
    ...
    /**
     * Check if <bosstype> has a value
     *
     * @return boolean
     */
    public function hasBosstype(){
      return $this->_has(5);
    }
    
    /**
     * Clear <bosstype> value
     *
     * @return \RO\Cmd\SummonBossSessionCmd
     */
    public function clearBosstype(){
     ...
     * @return \RO\Cmd\SummonBossSessionCmd
     */
    public function setBosstype( $value){
