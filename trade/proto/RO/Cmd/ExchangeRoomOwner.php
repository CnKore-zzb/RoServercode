...
namespace RO\Cmd {
  ...
  class ExchangeRoomOwner extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_CHATROOM_PROTOCMD;
    
    /**  @var int - \RO\Cmd\EChatRoomParam */
    public $param = \RO\Cmd\EChatRoomParam::ECHATROOMPARAM_CHANGEOWNER;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.ExchangeRoomOwner');
      ...
      $f->default   = \RO\Cmd\EChatRoomParam::ECHATROOMPARAM_CHANGEOWNER;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\ExchangeRoomOwner
     */
