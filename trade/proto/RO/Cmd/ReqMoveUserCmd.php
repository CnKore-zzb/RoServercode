...
namespace RO\Cmd {
  ...
  class ReqMoveUserCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::SCENE_USER_PROTOCMD;
    
    /**  @var int - \RO\Cmd\CmdParam */
    public $param = \RO\Cmd\CmdParam::REQ_MOVE_USER_CMD;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.ReqMoveUserCmd');
      ...
      $f->default   = \RO\Cmd\CmdParam::REQ_MOVE_USER_CMD;
      $descriptor->addField($f);
     ...
     * @return \RO\Cmd\ReqMoveUserCmd
     */
    public function setTarget(\RO\Cmd\ScenePos $value){
