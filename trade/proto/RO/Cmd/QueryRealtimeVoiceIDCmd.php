...
namespace RO\Cmd {
  ...
  class QueryRealtimeVoiceIDCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::CHAT_PROTOCMD;
    
    /**  @var int - \RO\Cmd\ChatParam */
    public $param = \RO\Cmd\ChatParam::CHATPARAM_QUERY_REALTIME_VOICE_ID;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.QueryRealtimeVoiceIDCmd');
      ...
      $f->default   = \RO\Cmd\ChatParam::CHATPARAM_QUERY_REALTIME_VOICE_ID;
      $descriptor->addField($f);
     ...
     * Clear <cmd> value
     *
     * @return \RO\Cmd\QueryRealtimeVoiceIDCmd
     */
