...
namespace RO\Cmd {
  ...
  class ItemLogCmd extends \DrSlump\Protobuf\Message {

    /**  @var int - \RO\Cmd\Command */
    public $cmd = \RO\Cmd\Command::LOG_PROTOCMD;
    
    /**  @var int - \RO\Cmd\LogParam */
    public $param = \RO\Cmd\LogParam::ITEM_LOG_CMD;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Cmd.ItemLogCmd');
      ...
      $f->default   = \RO\Cmd\LogParam::ITEM_LOG_CMD;
      $descriptor->addField($f);
    ...
    /**
     * Check if <amount2> has a value
     *
     * @return boolean
     */
    public function hasAmount2(){
      return $this->_has(19);
    }
     ...
     * @return \RO\Cmd\ItemLogCmd
     */
    public function setAmount2( $value){
