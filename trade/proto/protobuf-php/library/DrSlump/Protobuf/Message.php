...
abstract class Message implements \ArrayAccess, \Serializable, \JsonSerializable
{
    /** @var \Closure[] */
    ...
    public function serialize()
    {
        ...
        return $this->_data_cached = $codec->encode($this);
    }

    /**
     * 获取一个在初始化时parse的原始数据或上次 serialize() 时的数据
     *
     * @return string
     */
    public function getCachedSerialize()
    {
        return $this->_data_cached ? : $this->serialize();
    }
     ...
     * @param mixed $value
     * @param int|null $idx
     * @return \DrSlump\Protobuf\Message|mixed - Fluent interface
     */
